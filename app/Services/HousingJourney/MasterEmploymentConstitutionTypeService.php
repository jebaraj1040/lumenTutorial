...
use App\Imports\HjMasterEmploymentConstitutionTypeImport;
use App\Repositories\HousingJourney\MasterApiLogRepository;

class MasterEmploymentConstitutionTypeService extends Service
{
  /**
   *Save Import File
   *
  ...
  public function import(Request $request, MasterApiLogRepository $masterApiLogRepo)
  {
    ...
    $requestData['customHeader']['X-Api-Type'] = config('constants/masterApiType.MASTER_EMPLOYMENT_CONSITUTION_TYPE_IMPORT');
    ...
    Excel::import(new HjMasterEmploymentConstitutionTypeImport, $path);
