...
use App\Imports\HjMasterPropertyPurposeImport;
use App\Repositories\HousingJourney\MasterApiLogRepository;

class MasterPropertyPurposeService extends Service
{
  /**
   *Save Import File
   *
  ...
  public function import(Request $request, MasterApiLogRepository $masterApiLogRepo)
  {
    ...
    $requestData['customHeader']['X-Api-Type'] = config('constants/masterApiType.MASTER_PROPERTY_PURPOSE_IMPORT');
    ...
    Excel::import(new HjMasterPropertyPurposeImport, $path);
