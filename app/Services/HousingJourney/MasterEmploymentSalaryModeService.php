...
use App\Imports\HjMasterEmploymentSalaryModeImport;
use App\Repositories\HousingJourney\MasterApiLogRepository;

class MasterEmploymentSalaryModeService extends Service
{
  /**
   *Save Import File
   *
  ...
  public function import(Request $request, MasterApiLogRepository $masterApiLogRepo)
  {
    ...
    $requestData['customHeader']['X-Api-Type'] = config('constants/masterApiType.MASTER_EMPLOYMENT_SALARY_MODE_IMPORT');
    ...
    Excel::import(new HjMasterEmploymentSalaryModeImport, $path);
